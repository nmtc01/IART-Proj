...
- Compilação: 
	...
	Para compilar o projeto, abrir uma janela de terminal na pasta root do projeto, e executar o comando 'gradle build'; 
...
Menu: 
	...
	- O programa abrirá então uma janela com um menu navegável através das setas de seleção do computador onde os itens podem ser selecionados através da tecla enter. 
	
	- O botão Play inicia o jogo para o humano, onde após seleção pedirá a este para que escolha um nível a jogar; 
	
	- O botão Solve permitirá o computador resolver o puzzle com um dos algoritmos e níveis à escolha. 

	- O Botão Quit fecha o jogo.
